...
MACRO_CONFIG_INT(BombtagScoreForSurviving, bombtag_score_for_surviving, 0, 0, 10000, CFGFLAG_SERVER, "The amount of score given for players surviving a round.")
MACRO_CONFIG_INT(BombtagScoreForWinning, bombtag_score_for_winning, 1, 0, 10000, CFGFLAG_SERVER, "The amount of score given for the player who wins the round.")

MACRO_CONFIG_INT(BombtagSecondsToExplosion, bombtag_seconds_to_explosion, 15, 0, 86400, CFGFLAG_SERVER, "The amount of seconds till the bomb explodes.")
MACRO_CONFIG_INT(BombtagMinSecondsToExplosion, bombtag_minimum_seconds_to_explosion, 1, 0, 86400, CFGFLAG_SERVER, "The minimum amount of seconds a tee's bomb timer will have after getting bomb.")
...
MACRO_CONFIG_INT(BombtagHammerRefreezeable, bombtag_hammer_refreeze, 0, 0, 1, CFGFLAG_SERVER, "Whether hammer freeze should reapply the freeze when you're already frozen")
